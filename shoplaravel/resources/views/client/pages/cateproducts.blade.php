		...
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					@foreach($product_cate1 as $iteam)
					<label class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 how-active1" data-filter="*">
						{!! $iteam->name !!}
					</label>
					@endforeach
				</div>
			...
			<div class="row isotope" id="ajax1">
				@foreach($product_type as $iteam )
			...
			<div class="flex-c-m flex-w w-full p-t-45">
				<button id="load1" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">
					Xem Thêm
				</button>
			</div>
		</div>
