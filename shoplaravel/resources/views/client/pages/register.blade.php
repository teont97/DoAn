...
<div class="signup-form">
    <form action="{!! route('post.register') !!}" method="post">
        ...
        <div class="form-group">
        	<input type="text" class="form-control" name="txtname" placeholder="Họ Và Tên" required="required">
        </div>
        <div class="form-group">
		...
		<div class="form-group">
            <input type="password" class="form-control" name="confirm_password" placeholder="Xác Nhận Lại Mật Khẩu" required="required">
        </div>        
        <div class="form-group">
		<label class="col-xl-12"><input style="display: inline-block;" type="checkbox" required="required"> Bạn Có Đồng Ý <a href="#">Với Quy Định </a> Và <a href="#"> Nội Quy Tôi </a></l	abel>
		</div>
		<div class="form-group">
            <button type="submit" class="btn btn-success btn-lg btn-block">Đăng Ký Ngay</button>
        </div>
    </form>
